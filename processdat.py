...
plt.axvline(x=emargins[0]/scala, color='g', label='Esperanza')
plt.axvline(x=cred_inter[0][0], color='r', label='Credibilidad')
plt.legend()
...
plt.xlabel('$\sigma$ [$\AA$]')
plt.axvline(x=emargins[1], color='g', label='Esperanza')
plt.axvline(x=cred_inter[1][0], color='r', label='Credibilidad')
plt.legend()
...
plt.xlabel('Amplitud [$erg$ $s^{-1}$ $Hz^{-1}$ $cm^{-2}$]')
plt.axvline(x=emargins[2]/scala, color='g', label='Esperanza')
plt.axvline(x=cred_inter[2][0], color='r', label='Credibilidad')
plt.legend()
...
plt.xlabel('$\sigma$ [$\AA$]')
plt.axvline(x=emargins[3], color='g', label='Esperanza')
plt.axvline(x=cred_inter[3][0], color='r', label='Credibilidad')
plt.legend()
...
plt.xlabel('Amplitud [$erg$ $s^{-1}$ $Hz^{-1}$ $cm^{-2}$]')
plt.axvline(x=emargins[4]/scala, color='g', label='Esperanza')
plt.axvline(x=cred_inter[4][0], color='r', label='Credibilidad')
plt.legend()
...
plt.xlabel('$\sigma$ [$\AA$]')
plt.axvline(x=emargins[5], color='g', label='Esperanza')
plt.axvline(x=cred_inter[5][0], color='r', label='Credibilidad')
plt.legend()
plt.axvline(x=cred_inter[5][1], color='r')
plt.savefig('S22.eps')

x = np.linspace(wavelen[0], wavelen[121], 1000)
plt.figure(7)
plt.plot(wavelen, frec, 'ko', label='Datos originales')
plt.plot(x, 10**(-16) - E[2]/scala * gaussian(x, 6563, E[3]), 'r',
         label='Modelo 1')
plt.legend(loc=4)
plt.xlim([6500, 6620])
plt.title('Ajuste de modelos a l'u'í''nea de absorci'u'ó''n: Modelo 1')
...
plt.figure(8)
plt.plot(wavelen, frec, 'ko', label='Datos originales')
plt.plot(x, 10**(-16) - E[4]/scala * gaussian(x, 6563, E[5]) -
         E[6]/scala * gaussian(x, 6563, E[7]), 'b', label='Modelo 2')
plt.legend(loc=4)
plt.plot(x, 10**(-16) - E[4]/scala * gaussian(x, 6563, E[5]), 'b--')
plt.plot(x, 10**(-16) - E[6]/scala * gaussian(x, 6563, E[7]), 'b--')
plt.xlim([6500, 6620])
plt.title('Ajuste de modelos a l'u'í''nea de absorci'u'ó''n: Modelo 2')
plt.xlabel('Longitud de onda [$\AA$]')
plt.ylabel('$F_{\\nu}$ [$erg$ $s^{-1}$ $Hz^{-1}$ $cm^{-2}$]')
