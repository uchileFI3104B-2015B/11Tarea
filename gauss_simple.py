...
''' Script que ajusta 2 modelos a el set de datos de una línea de absorción,
el primer modelo consiste en una gaussiana, y el segunda
en una suma de Gaussianas, utilizando métodos Bayesianos'''
...
def plot_distribution(x, y, z, cmap='coolwarm'):
